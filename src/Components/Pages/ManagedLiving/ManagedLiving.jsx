      ...
      <section className="py-16 bg-[#fdfdfb] px-6 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row justify-between items-end mb-20 gap-8">
            ...
            <p className="lg:w-1/3 text-slate-500 italic text-sm border-l border-[#b4a14c] pl-6 py-2">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  ...
                  <h4 className="text-2xl font-bold mb-6">
                    What is <br />
                    <span className="text-[#b4a14c] italic">
                      Managed Living?
                    </span>
                  </h4>
              ...
              >
                ...
                <ul className="space-y-5">
                  {role.points.map((p, i) => (
                    <li
                      key={i}
                      className="flex items-center gap-4 text-slate-600 text-sm group/item"
                    >
      ...
      <section className="py-10 bg-white px-6 lg:px-0">
        <div className="container mx-auto rounded-4xl lg:rounded-[5rem] overflow-hidden relative shadow-3xl min-h-100  flex items-center">
          ...
          <div className="absolute inset-0 z-0">
            ...
            <div className="absolute inset-0 bg-linear-to-b from-[#4d633c] via-[#4d633c]/85 to-[#4d633c]/80 backdrop-blur-[2px]" />
          </div>
                ...
                {[
                  ...
                  >
                    ...
                    <div className="py-4 border-b border-white/5 grow group-hover:border-[#b4a14c]/30 transition-colors">
                      ...
                      <p className="text-white text-[10px] uppercase tracking-[0.2em] font-medium">
                        {s.sub}
                      </p>
                    </div>
                  </div>
          ...
          <div className="flex flex-col lg:flex-row gap-20">
            ...
            <div className="lg:w-1/3">
              <div className="sticky top-10">
                ...
                <h2 className="text-4xl text-slate-900 mb-8">
                  Transparency 
            ...
            <div className="lg:w-2/3 space-y-6">
              {faqs.map((f, i) => (
                ...
                >
                  <summary className="list-none p-10 flex justify-between items-center cursor-pointer select-none">
                  ...
                  <div className="px-10 pb-10 text-slate-500 pt-0 leading-relaxed text-sm animate-fadeIn">
                    <div className="pt-6 border-t border-slate-50">{f.a}</div>
                  </div>
                </details>
              ))}
            </div>
